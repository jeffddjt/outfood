...
class AddSmall extends Component {
        ...
        return (
            <div className="contentBox">
                ...
                <div className="add_title">
                    <span style={{ margiLeft: "10px" }}>添加小餐饮单位</span>
                </div>
                    ...
                    <div className="input_box">
                        ...
                        <div className="input_component" style={{ cursor: "pointer" }}>
                            <select id="district" defaultValue={this.state.selectedDistrict}>
                                <option value="-1">请选择该餐饮单位归属辖区</option>
                                {
                ...
                <div className="tabs" style={{ height: "380px" }}>
                    <div className="content">
                        <div className={this.state.activeForm === 0 ? "active" : ""} onClick={() => { this.setState({ activeForm: 0 }) }}>营业执照</div>
                        <div className={this.state.activeForm === 1 ? "active" : ""} onClick={() => { this.setState({ activeForm: 1 }) }}>小餐饮登记证</div>
                    </div>
                ...
                <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                    <div className="handel">
                        <div className="point">保存</div>
                        <div className="point" onClick={this.nav.bind(this, "registrationShow")}>取消</div>
                    </div>
                </div>
            </div>
